...
/*
Реализовать представление - отчет о заказанных турах
за месяц, которое должно содержать:название тура, стоимость тура, стоимость одной путевки (без скидок),
средняя стоимость путевки (с учетом скидок) , количество проданных путевок и итоговый доход
*/



/*
Реализовать автоматическое изменение количества акционных предложений (оставшееся число ) при совершении
